...
class PCList(models.Model):
	...
	title = models.CharField(max_length=5,blank=True, null=True ,choices=[('mr', 'Mr'), ('mrs', 'Mrs'), ('ms', 'Ms')],)
	...
	therapist = models.CharField(max_length=20,blank=True, null=True ,choices=[('dr_suthiesh', 'Dr_suthiesh'), ('dr_basidh', 'Dr_basidh'), ('dr_visitra', 'Dr_visitra'), ('dr_bharatiselvi', 'Dr_bharatiselvi')],)
